                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        ...
                        <ul class="payments-types">
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/bkash.png') }}" alt="bkash"
                                        title="Bkash"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/nogod.png') }}" alt="nogod"
                                        title="Nogod"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/dbbl.png') }}" alt="dbbl"
                                        title="DBBL"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/rocket.png') }}" alt="rocket"
                                        title="Rocket"></a></li>

                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/visa.png') }}" alt="visa"
                                        title="Visa Card"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/discover.png') }}" alt="discover"
                                        title="Discover"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/american.png') }}"
                                        alt="american express" title="American Express"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip"
                                        src="{{ asset('frontend/images/payment/mastercard.png') }}" alt="discover"
                                        title="Master Card"></a></li>
                        </ul>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <p>Subscribe</p>
            ...
            <div class="container">
                <div class="footer-copyright">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{ route('contactUs') }}">Contact Us</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('faq') }}">Faq</a> </li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('support') }}">Support</a> </li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('termsOfUse') }}">Terms of Use</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('privacyPolicy') }}">Privacy
                                Policy</a> </li>
                    </ul>
                    <p class="copyright-text">Copyright © 2020 <a
                            href="{{ route('home') }}">{{ env('APP_NAME') }}</a>. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
        <!-- Footer end -->