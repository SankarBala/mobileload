...
<head>
    ...
    <!-- others css -->
    <link rel="stylesheet" href="backend/css/typography.css">
    <link rel="stylesheet" href="backend/css/default-css.css">
...
<body>
										...
										<div class="nofity-list">
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="backend/images/author/author-img1.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="backend/images/author/author-img2.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="backend/images/author/author-img3.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="backend/images/author/author-img4.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                <td class="mv-icon"><img src="backend/images/icon/market-value/icon1.png" alt="icon">
                                                </td>
                                                <td class="coin-name">Dashcoin</td>
                                                <td class="buy">30% <img src="backend/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="backend/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="backend/images/icon/market-value/trends-up-icon.png" alt="icon"></td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="backend/images/icon/market-value/icon2.png" alt="icon"></div>
                                                </td>
                                                <td class="coin-name">LiteCoin</td>
                                                <td class="buy">30% <img src="backend/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="backend/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="backend/images/icon/market-value/trends-down-icon.png" alt="icon"></td>
                                                <td class="attachments">$ 56746,857</td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="backend/images/icon/market-value/icon3.png" alt="icon"></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="backend/images/icon/market-value/icon4.png" alt="icon"></div>
                                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="letest-news mt-5">
                                    <div class="single-post mb-xs-40 mb-sm-40">
                                        <div class="lts-thumb">
                                            <img src="backend/images/blog/post-thumb1.jpg" alt="post thumb">
                                        </div>
                                    ...
                                    <div class="single-post">
                                        <div class="lts-thumb">
                                            <img src="backend/images/blog/post-thumb2.jpg" alt="post thumb">
                                        </div>
                                        <div class="lts-content">
                                            <span>Admin Post</span>
                                            <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
    ...
    <script src="backend/js/vendor/jquery-2.2.4.min.js"></script>
    <!-- bootstrap 4 js -->
    ...
    <script src="backend/js/jquery.slicknav.min.js"></script>
    ...
    <script src="backend/js/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="backend/js/pie-chart.js"></script>
    <!-- others plugins -->
