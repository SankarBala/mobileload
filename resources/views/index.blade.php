 ...
 <div id="content" class="py-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            ...
                            <form id="recharge-bill" method="post">
                                ...
                                <a class="btn btn-primary btn-block" href="recharge-order-summary.html">Continue to
                                    Recharge</a>
                            </form>
                        </div>
                        <!-- Mobile Recharge end -->
                        ...
                        <!-- Slideshow -->
                        <div class="col-lg-8">
                            <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut"
                                ...
                                <div class="item"><a href="#"><img class="img-fluid"
                                            src="{{ asset('frontend/images/slider/banner-1.jpg') }}"
                                            alt="banner 1" /></a></div>
                                <div class="item"><a href="#"><img class="img-fluid"
                                            src="{{ asset('frontend/images/slider/banner-2.jpg') }}"
                                            alt="banner 2" /></a></div>
                            </div>
                        </div>
                        <!-- Slideshow end -->
                ...
                <div class="container">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab"
                                href="#mobile-recharge" role="tab" aria-controls="mobile-recharge"
                                aria-selected="true">Mobile Recharge</a> </li>
                        <li class="nav-item"> <a class="nav-link" id="bulksms-tab" data-toggle="tab" href="#bulksms"
                                role="tab" aria-controls="bulksms" aria-selected="false">Bulk SMS</a> </li>
                        <li class="nav-item"> <a class="nav-link" id="why-quickai-tab" data-toggle="tab"
                                href="#why-quickai" role="tab" aria-controls="why-quickai" aria-selected="false">Why
                                Quickai</a> </li>
                    </ul>
            ...
            <div class="container">
                <section class="section bg-white shadow-md rounded px-5">
                    ...
                    <div class="text-center pt-4"> <a href="{{ route('fallback', 'referral') }}"
